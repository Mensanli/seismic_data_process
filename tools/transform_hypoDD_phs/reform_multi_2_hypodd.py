...
# last mod 2021/11/29
# 
# mslphs (from hypoinvers / CSF): "# 2021 11 21 18 40 15.85 37.091 77.012 15 1.9 0.695 20211121184015 1"  "XJ AKZ 2021 11 21 18 40 24.82 S"
    ...
    for line in f.read().splitlines():
        ...
        if len(item)>0:
            ...
            if item[0]=="DBO" and item[7]=="ML":
                ...
                dd=pickp-origin
                print("%-2s%-4s%9.2f%7.3f%4s"%(net,station,dd,1,pick))
